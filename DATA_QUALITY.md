...
Not fixed. This is a real, separate class of bug (transitive restriction conflicts through a prerequisite chain, rather than a course's own restriction field) worth its own investigation, not a quick extension of the direct-restriction check.
