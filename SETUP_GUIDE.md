...
Everything you need to do, in order, to get the planner running and keep improving it.
...
This is the single biggest gap. Without this, ~34% of L200+ courses show a ⚠ "prerequisites unknown" warning. With it, the planner knows the real AND/OR prerequisite logic for every course.
...
Look for `"prereq_coverage"`. It should now show >80% instead of ~66%.
